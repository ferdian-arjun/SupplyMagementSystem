...
public class UserController : ControllerBase
{
    ...
    public IActionResult GetAll()
    {
        try
        {
            ...
            if (!result.Any())
                return NotFound(new ResponseDataHandler<GetUsersDto>
                {
                    Code = StatusCodes.Status404NotFound,
                    Status = HttpStatusCode.NotFound.ToString(),
                    Message = "Data Not Found"
                });
            return Ok(new ResponseDataHandler<IEnumerable<GetUsersDto>>
            {
    ...
    public ActionResult GetByGuid(string guid)
    {
        try
        {
            ...
            return Ok(new ResponseDataHandler<GetUsersDto>
            {
                Code = StatusCodes.Status200OK,
                Status = HttpStatusCode.OK.ToString(),
                Message = "Data Found",
    ...
    public IActionResult Create(CreateUserDto createUserDto)
    {
        try
        {
            ...
            if (create is null)
                return BadRequest(new ResponseDataHandler<GetUsersDto>
                {
