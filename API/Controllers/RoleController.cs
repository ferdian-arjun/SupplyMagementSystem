...
public class RoleController : ControllerBase
{
    ...
    public IActionResult GetAll()
    {
        try
        {
            ...
            if (!result.Any())
                return NotFound(new ResponseDataHandler<GetRoleDto>
                {
                    Code = StatusCodes.Status404NotFound,
                    Status = HttpStatusCode.NotFound.ToString(),
                    Message = "Data Not Found"
                });
            return Ok(new ResponseDataHandler<IEnumerable<GetRoleDto>>
            {
    ...
    public ActionResult GetByGuid(string guid)
    {
        try
        {
            ...
            return Ok(new ResponseDataHandler<GetRoleDto>
            {
                Code = StatusCodes.Status200OK,
                Status = HttpStatusCode.OK.ToString(),
                Message = "Data Found",
    ...
    public IActionResult Update(UpdateRoleDto updateRoleDto)
    {
        try
        {
            var update = _roleService.UpdateRole(updateRoleDto);
            if (update is -1)
    ...
    public IActionResult Delete(string guid)
    {
        try
        {
            var delete = _roleService.DeleteRole(guid);
    ...
    public IActionResult Create(CreateRoleDto createRoleDto)
    {
        try
        {
            var create = _roleService.CreateRole(createRoleDto);
            if (create is null)
                return BadRequest(new ResponseDataHandler<GetRoleDto>
                {
